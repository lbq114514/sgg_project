"""PredCls ablation C: dual-view RCA plus logit adjustment from scratch.
...
# Use the same full schedule as A/B and the existing tail-aux main experiment.
...
cfg["SOLVER"]["OUTPUT_DIR"] = os.environ.get(
    "OUTPUT_DIR", "outputs/star_predcls_ablation_dual_la_scratch"
)
